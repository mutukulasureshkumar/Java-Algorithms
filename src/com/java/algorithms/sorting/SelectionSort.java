...
public class SelectionSort {
	 ...
	 * will compare every element which are after outer loop element in the
	 * array with the outer loop element and finds the smallest element then the
	 * outer element and replace their positions.
	 * 
	 * 
